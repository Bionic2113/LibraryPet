...
import com.caterpillar.shamil.proto.UpdatePersonServiceGrpc;
 ...
 */
@GRpcService
public class PeopleUpdateServiceGrpc extends UpdatePersonServiceGrpc.UpdatePersonServiceImplBase {

    private final PeopleRepository peopleRepository;

    public PeopleUpdateServiceGrpc(PeopleRepository peopleRepository) {
        this.peopleRepository = peopleRepository;
    }

    @Override
    public void updatePerson(People.Person request,
                             StreamObserver<People.Person> responseObserver) {
        ...
        if(person.isEmpty()){
            ...
            person_true.setLastname(request.getLastName());
            person_true.setFirstname(request.getFirstName());
            person_true.setPatronymic(request.getPatronymic());
